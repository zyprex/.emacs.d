...
(setq i-abb/table
      '(
        ...
        ((java-mode) . ("ma" "public static void main(String[] args){\n" "\n}"))
        ((java-mode) . ("pr" "System.out.println(" ");"))
        ((c-mode cc-mode) . ("so" "sizeof(" ")"))
        ((c-mode cc-mode js-mode web-mode java-mode) . ("do" "do {\n" "\n} while(0);"))
        ((c-mode cc-mode js-mode web-mode java-mode) . ("wh" "while (" ") {\n}"))
        ((c-mode cc-mode js-mode web-mode java-mode) . ("fo" "for (" ") {\n}"))
        ((c-mode cc-mode js-mode web-mode java-mode) . ("if" "if (" ") {\n}"))
        ((c-mode cc-mode js-mode web-mode java-mode) . ("ef" "else if (" ") {\n}"))
        ((c-mode cc-mode js-mode web-mode java-mode) . ("el" "else {\n" "\n}"))
        ((c-mode cc-mode js-mode web-mode java-mode) . ("sw" "switch (" ") {\n}"))
        ((c-mode cc-mode js-mode web-mode java-mode) . ("ca" "case " ":\nbreak;"))
        ((c-mode cc-mode js-mode web-mode java-mode) . ("?" "(" ") ? : ;"))
        ((c-mode cc-mode js-mode web-mode java-mode) . ("re" "return" ";"))
        ((c-mode cc-mode java-mode) . ("fu" "" "() {\n}"))
